...
public class dmtSyringe extends Item {
    public dmtSyringe(Properties pProperties) {
        super(pProperties);
    }
    @Override
    public @NotNull
    InteractionResultHolder<ItemStack> use(@NotNull Level worldIn, Player playerIn, @NotNull InteractionHand handIn) {
        ...
        playerIn.addEffect(new MobEffectInstance(RegistryHandler.DMT_EFFECT.get(), 400, 4, false, true));

...
public class Food {
    ...
    public static final FoodProperties SHROOMS = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.1F).effect(new MobEffectInstance(MobEffects.CONFUSION, 24000, 5), 1F).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 24000, 4), 1F).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 24000, 2), 1F).build();
